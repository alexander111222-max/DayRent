...
# ПЕЧАТАЕМ ДЛЯ ПРОВЕРКИ (ты должен увидеть это в консоли)
print("--- АЛЕМБИК ЗАПУСТИЛСЯ ИЗ ПРАВИЛЬНОГО ФАЙЛА ---")
...
if os.path.exists(ini_path):
    print(f"--- КОНФИГ НАЙДЕН ТУТ: {ini_path} ---")
    fileConfig(ini_path)
else:
    print(f"--- КРИТИЧЕСКАЯ ОШИБКА: КОНФИГ НЕ НАЙДЕН ПО ПУТИ {ini_path} ---")
